...
![El diagrama a pantalla completa que aquí calibras: arriba los iconos de calibrar, zoom y cerrar, dos líneas llevan las etiquetas Parte superior de la cuadrícula y Parte inferior de la cuadrícula a unas filas de distancia, y abajo Restablecer, Cancelar y Guardar.](images/es/03c-diagramme-calage.webp)
...
![El diagrama granny calibrado, a pantalla completa, con puntos deliberadamente desenfocados: las dos primeras vueltas terminadas están rodeadas por un anillo discreto desde la flor central, la tercera vuelta, la actual, resalta en un anillo más grueso, el límite exterior de la calibración lo enmarca con guiones, y la barra de abajo muestra 3 de 5 entre un botón de menos y uno de más, seguidos de la inversión de la cortina](images/es/03i-granny-cale.webp)
...
![El diagrama ampliado a pantalla completa: la fila en curso lleva un recuadro y una parte teñida, las filas de debajo quedan teñidas, y abajo aparecen menos, 7 de 24, más y el botón para invertir.](images/es/03d-diagramme-rideau.webp)
...
![El lector en dos paneles en tableta: a la izquierda el Gorro de Trenzas, su sección Borde en punto elástico al 0/3 y Montar 96 p. con agujas circulares del 4; a la derecha Diagrama · 8 p. × 24 vueltas, en la vuelta 7 de 24.](images/es/03e-tablette-lecteur.webp)
...
![La pantalla Biblioteca de patrones: arriba los filtros Todos 3, Ropa 0, Accesorios 3 y un cuarto cortado por el borde derecho, debajo el botón Añadir un patrón a todo lo ancho y tres fichas (el Bolso Granny de ganchillo, la Bufanda Nube de punto y el Gorro de Trenzas en tallas S, M y L)](images/es/04-bibliotheque.webp)
...
![Bajo el título Corregir el patrón, el bloque Muestra indica 20 p. × 26 vueltas en punto jersey, agujas del 4,5 = 10 × 10 cm, después el bloque Hilo, el título Agujas/Ganchillo y la barra Cancelar y Guardar](images/es/04c-correction-editeur.webp)
...
![La pantalla Contador con el campo del nombre vacío: bajo cada una de las dos casillas hay un ejemplo, una manga y repetir las filas 1 a 8 cinco veces; más abajo, Aún no hay contadores, añade uno.](images/es/06a-compteurs.webp)

*El contador libre, utilizable sin proyecto: le das un nombre y eliges si sigue aumentos/disminuciones o repeticiones.*

![Tres selectores marcan Aumentos, En plano y Reparto; debajo los campos Puntos actuales 60, Puntos objetivo 80, Aumentos cada vez 1 y En cuántas filas 40, los cuatro todavía como marcadores, con el aviso de rellenar los campos.](images/es/06b-calculateur.webp)
...
![Encontrar mi medida de agujas con los campos rellenados: Muestra de la etiqueta indica 4 mm, 22 puntos y 30 filas por 10×10 cm, Muestra objetivo 20 y 28, y la respuesta Prueba una medida más grande: 4,5 mm.](images/es/06c-aiguilles.webp)
...
![Los ajustes en tarjetas: en Perfil aparece Camille, la técnica predeterminada marcada es Punto y debajo un botón Guardar; después, la apariencia en Sistema, el bloque Color ambiental con sus diez pastillas y su deslizador de tono, el primer día de la semana en Lunes y, al borde inferior, solo el título Idioma.](images/es/08-reglages.webp)
