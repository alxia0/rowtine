...
![Le plein écran qui sert à caler le diagramme : en haut « Diagramme · 8 m × 24 ra… » et les icônes de calage, de zoom et de fermeture ; deux lignes étiquetées Haut du quadrillage et Bas du quadrillage à quelques rangs l'une de l'autre ; en bas Réinitialiser, Annuler et Enregistrer](images/fr/03c-diagramme-calage.webp)
...
![Le diagramme granny calé, plein écran, aux points volontairement flous : les deux premières rondes finies sont cerclées d'un anneau discret depuis la fleur centrale, la troisième ronde, en cours, ressort dans un anneau plus épais, la limite extérieure du calage encadre le tout en pointillés, et la barre du bas affiche 3 sur 5 entre un bouton moins et un bouton plus, suivis du retournement du rideau](images/fr/03i-granny-cale.webp)
...
![Le rang en cours cerclé, la manette à double flèche posée en son milieu, les rangs déjà faits teintés en dessous, et en bas − 7 / 24 + avec le bouton qui inverse le côté teinté](images/fr/03d-diagramme-rideau.webp)
...
![Les pastilles Tous (3), Vêtements (0), Accessoires (3) et une quatrième coupée par le bord droit, le bouton pleine largeur « + Ajouter un patron », puis Sac Granny en crochet, Écharpe Nuage en tricot et Bonnet Torsade, seul à porter ses tailles S, M, L](images/fr/04-bibliotheque.webp)
...
![Sous le titre « Corriger le patron », le bloc Échantillon donne 20 m. × 26 tours en jersey endroit, aiguilles n° 4,5 = 10 × 10 cm, puis le bloc Fil, le titre Aiguilles/Crochet et la barre Annuler / Enregistrer](images/fr/04c-correction-editeur.webp)
...
![Le champ « Nom du compteur » encore vide, les deux cases décochées avec leur exemple (une manche, ou « répéter les rangs 1 à 8, 5 fois »), puis « + Compteur » et « Aucun compteur. Ajoute-en un. »](images/fr/06a-compteurs.webp)
...
![Augmentations, À plat et Répartition retenus, puis les champs vides Mailles actuelles, Mailles cibles, Augmentations à chaque fois et Sur combien de rangs, indiqués 60, 80, 1 et 40](images/fr/06b-calculateur.webp)
...
![Trouver ma taille d'aiguilles, champs remplis : « Échantillon de l'étiquette » donne 4 mm, 22 mailles et 30 rangs pour 10×10 cm, « Échantillon visé (du patron) » 20 et 28, puis « Essaie une taille au-dessus : 4,5 mm. »](images/fr/06c-aiguilles.webp)
...
![Camille est saisie dans « Ton prénom (facultatif) », Tricot est retenu comme technique par défaut et un bouton Enregistrer ferme la carte Profil, puis Apparence sur Système, le bloc Couleur d'ambiance avec ses dix pastilles et son curseur de teinte, Premier jour de la semaine sur Lundi, et le titre Langue au bord inférieur du cadre](images/fr/08-reglages.webp)
